...
public class Menu extends javax.swing.JPanel {
    ...
    public void initMenuItem() {
        ...
        addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/com/raven/icon/5.png")), "Quản lý tài khoản", "Nhân viên", "Khách hàng"));
    ...
    protected void paintComponent(Graphics grphcs) {
        ...
        GradientPaint gra = new GradientPaint(0, 0, Color.RED, getWidth(), 0, Color.BLACK); // Đổi màu nền từ đỏ đến đen
        g2.setPaint(gra);
