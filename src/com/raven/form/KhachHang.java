...
public class KhachHang extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        if (tblLichSuMuaHang.getColumnModel().getColumnCount() > 0) {
            tblLichSuMuaHang.getColumnModel().getColumn(0).setMinWidth(60);
            tblLichSuMuaHang.getColumnModel().getColumn(0).setPreferredWidth(60);
            tblLichSuMuaHang.getColumnModel().getColumn(0).setMaxWidth(60);
            tblLichSuMuaHang.getColumnModel().getColumn(1).setMinWidth(70);
            tblLichSuMuaHang.getColumnModel().getColumn(1).setPreferredWidth(70);
            tblLichSuMuaHang.getColumnModel().getColumn(1).setMaxWidth(70);
        }
        ...
        jPanel5Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {btnLamMoi, btnSua, btnThem, btnXoa});
        ...
        jPanel5Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {btnLamMoi, btnSua, btnThem, btnXoa, jButton13});
        ...
        if (tblkhachhang.getColumnModel().getColumnCount() > 0) {
            tblkhachhang.getColumnModel().getColumn(0).setMinWidth(30);
            ...
            tblkhachhang.getColumnModel().getColumn(2).setPreferredWidth(70);
            tblkhachhang.getColumnModel().getColumn(2).setMaxWidth(70);
            tblkhachhang.getColumnModel().getColumn(3).setMinWidth(80);
            tblkhachhang.getColumnModel().getColumn(3).setMaxWidth(80);
            tblkhachhang.getColumnModel().getColumn(4).setMinWidth(100);
            tblkhachhang.getColumnModel().getColumn(4).setMaxWidth(100);
            tblkhachhang.getColumnModel().getColumn(7).setMinWidth(30);
            tblkhachhang.getColumnModel().getColumn(7).setMaxWidth(30);
        }
        ...
        if (tblKhachHangDeleted.getColumnModel().getColumnCount() > 0) {
            tblKhachHangDeleted.getColumnModel().getColumn(0).setMinWidth(30);
            tblKhachHangDeleted.getColumnModel().getColumn(0).setMaxWidth(30);
            tblKhachHangDeleted.getColumnModel().getColumn(2).setMinWidth(70);
            tblKhachHangDeleted.getColumnModel().getColumn(2).setMaxWidth(70);
            tblKhachHangDeleted.getColumnModel().getColumn(3).setMinWidth(75);
            tblKhachHangDeleted.getColumnModel().getColumn(3).setMaxWidth(75);
            tblKhachHangDeleted.getColumnModel().getColumn(4).setMinWidth(60);
            tblKhachHangDeleted.getColumnModel().getColumn(4).setMaxWidth(60);
        }
