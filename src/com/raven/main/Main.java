            ...
            public void menuSelected(int menuIndex, int subMenuIndex) {
                ...
                if (menuIndex == 4) {
                    if (subMenuIndex == 0) {
                        if (Auth.user.isVaiTro()) {
                            ...
                            JOptionPane.showMessageDialog(rootPane, "Bạn không được phép");
                        }
                ...
                if (menuIndex == 5) {
                    if (Auth.user.isVaiTro()) {
                        ...
                        JOptionPane.showMessageDialog(rootPane, "Bạn không có quyền xem thống kê");
                    }
